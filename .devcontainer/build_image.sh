...
docker build --build-arg CPPTEST_STD="${CPPTEST_STD_PACKAGE}" --build-arg CPPTEST_CT="${CPPTEST_CT_PACKAGE}" --build-arg GITHUB_PAT="${PARASOFT_SE_GP}" --build-arg GITHUB_AGENT_VERSION="${GITHUB_AGENT_VERSION}" -t parasoft_iceoryx_demo .
