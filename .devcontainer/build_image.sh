...
PARASOFT_SE_GITHUB_PAT=11BCQ7ODQ09CQmrzDMk6HB_Aso24nNHz3O36rAPGImnHzvCyy8y7C5zjpGecLNnYmyGMWC4XMKMT2cIYG6
...
docker build --build-arg CPPTEST_STD="${CPPTEST_STD_PACKAGE}" --build-arg CPPTEST_CT="${CPPTEST_CT_PACKAGE}" --build-arg GITHUB_PAT="github_pat_${PARASOFT_SE_GITHUB_PAT}" --build-arg GITHUB_AGENT_VERSION="${GITHUB_AGENT_VERSION}" -t parasoft_iceoryx_demo .
